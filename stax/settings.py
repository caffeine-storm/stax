# Django settings for stax project.
...
SECRET_KEY = '+oq59p-y%(rjlnl)6ngdxft3(@5s^nfw@#8qbqsekktkw+srr@'
...
ROOT_URLCONF = 'stax.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'stax.wsgi.application'
